      ...
      <div className="bg-white border-2 border-slate-200 p-12 shadow-2xl relative training-record-content">
        ...
        <div className="flex justify-between items-start border-b-4 border-slate-900 pb-8 mb-10">
          ...
          <div className="text-right">
             <div className="bg-slate-900 text-white px-4 py-2 rounded font-black text-[10px] uppercase tracking-[0.2em] mb-3">AeroCert Aviation</div>
        ...
        <div className="grid grid-cols-2 gap-12 mb-12">
           <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-lg font-black text-slate-900 border-b border-slate-100 pb-1">{instructor?.name || 'Authorized AeroCert Instructor'}</p>
        ...
        <div className="mt-20 flex justify-between items-end">
           ...
           <div className="bg-slate-50 p-6 border-2 border-double border-slate-200 rounded-2xl rotate-1">
              ...
              <div className="w-20 h-20 border-4 border-blue-600/20 rounded-full flex items-center justify-center text-blue-600 font-black text-[10px] flex-col opacity-50">
                <span className="tracking-tighter">AeroCert</span>
        ...
        <div className="mt-16 pt-6 border-t border-slate-100 text-[8px] text-slate-400 font-bold uppercase tracking-widest text-center leading-relaxed">
          This document is generated by the AeroCert Learning Management System. It serves as an official training record for regulatory compliance under the jurisdiction of airport authorities and associated civil aviation requirements. All audit logs related to this record are stored securely.
        </div>
      </div>
